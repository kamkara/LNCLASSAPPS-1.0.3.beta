...
class MaterialsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create material" do
    assert_difference('Material.count') do
      post materials_url, params: { material: { slug: @material.slug, title: @material.title, user_id: @material.user_id } }
    end
  ...
  test "should update material" do
    patch material_url(@material), params: { material: { slug: @material.slug, title: @material.title, user_id: @material.user_id } }
